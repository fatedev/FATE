...
;		
;------------------------------------------------------------------------------
@if exp="typeof global.actor_object == 'undefined'"
@iscript
Scripts.execStorage("subroutine.tjs");

class ActorPlugin extends KAGPlugin
{
	var window;
...
kag.addPlugin(global.actor_object = new ActorPlugin(kag));
...
;マクロを登録する
@macro name="actor"
@eval exp="actor_object.init(mp)"
@endmacro

@macro name="wactor"
@if exp="actor_object.doing"
@waittrig * name="actor" onskip="actor_object.finish()" canskip=%canskip|false
@endif
@endmacro
