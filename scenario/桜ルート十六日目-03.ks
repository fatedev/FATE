...
@dashcomboT storage=30光の逆風 layer=base cx=c cy=c imag=1.0 mag=1.2 opacity=64 wait=0 time=200
...
@dashcomboT storage=30光の逆風d layer=base cx=c cy=c imag=2.1 mag=5.0 opacity=128 wait=0 time=400
@flushover method=crossfade time=400
@texton
「[line8]」[l][r]
　冷静さを欠く。[l][r]
　光を凌駕する思考速度を以って白熱する。[l][r]
　発狂はとうに過去であり、狂知覚こそがスタート地点。
@pg
*page2|
「[line4][ruby text="トレ"]投[ruby text="ース"]影、[ruby text="フラ"]重[ruby text="クタル"]装」[l][r]
@r
　際限なく縮小し際限なく拡大し際限なく増殖する。[l][r]
　空想は混濁と化しながら法則を持ち、無より生じるソ
レは無より生じたのではなく拡大する事で浮かび上がる
多くの類似。
@pg
*page3|
@textoff
...
@r
@r
　　「[line4][ruby text="我"]I[ruby text="が"] [ruby text="骨"]a[ruby text="子"]m the [ruby text="　　　は"]bo[ruby text="　　　捻"]n[ruby text="　　　じ"]e[ruby text="　　　れ"] of m
[ruby text="　　　狂"]y[ruby text="　　　う"] [ruby text="　　　。"]sword.」
@pg
*page4|
@r
　刹那を抜いて投影した剣を構える。
...
@r
@r
　　　　　　　　「偽[ruby text="カラ"]・[ruby text="ドボ"]螺[ruby text="ルグ"]旋剣」
@pg
*page6|
@r
　狙う必要はない。[l][r]
　既に[ruby text="あた"]的るイメージがある以上、この一矢は必ずセイバー
に食らいつく。
@pg
*page7|
@textoff
...
@dashcomboT storage=C02弓矢(一本) layer=base flipud=true cx=252 cy=200 imag=8.0 mag=1.0 opacity=128 wait=0 time=400 accel=3
...
@r
　その成果を、破裂した左眼で見る。[l][r]
　ライダーはセイバーから離脱している。[l][r]
　放たれた螺旋の剣を弾いたセイバーは、ライダーを追
えずにたたらを踏んでいる。[l][r]
@r
　その隙、時間にして僅か二秒間。[l][r]
